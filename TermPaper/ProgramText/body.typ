...
#h(2em) Программа, представляющая собой десктоп-приложение -- реализацию работы шифровальной машины Энигма, состоит из файлов, описывающих классы в зависимости от функционала, который они реализуют. Ознакомиться с текстом программы можно на сайте Github по ссылке: https://github.com/Misss-Lacoste/Term-Paper
